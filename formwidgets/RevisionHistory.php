...
class RevisionHistory extends FormWidgetBase
{
    ...
    {
        $onLabel = isset($field->config['on']) ? Lang::get($field->config['on']) : Lang::get('backend::lang.form.field_on');
        $offLabel = isset($field->config['on']) ? Lang::get($field->config['off']) : Lang::get('backend::lang.form.field_off');
